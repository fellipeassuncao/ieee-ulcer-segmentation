...
public class Directory {
    ...
    private File svmClassificationPath;
    ...
    public void updatePaths(File dirPath, String imageName, Configuration configuration) {
        ...
        this.svmClassificationPath = new File(dirPath.getAbsolutePath().concat("\\").concat(imageName).concat(configuration.getSvmClassificationImageName()).concat(configuration.getExtension()));
