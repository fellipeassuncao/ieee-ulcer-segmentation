...
function  demo(imgPath,nC,lambda_prime,sigma,conn8,label_path,border_path)
%close all;clc
...
img = imread(imgPath);
nC = str2double(nC);
lambda_prime = str2double(lambda_prime);
sigma = str2double(sigma);
conn8 = str2double(conn8);
...
%// Save Images
%//=======================================================================
%imwrite(labels,path_labels)
%imwrite(borders,path_borders)
imwrite(out,label_path)
imwrite(bmap,border_path)    
