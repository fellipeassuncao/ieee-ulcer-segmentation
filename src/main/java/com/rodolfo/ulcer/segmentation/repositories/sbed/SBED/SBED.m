...
% Inimg is the image to be processed
% K is the number of output superpixels, it should be set as 1500
% C is the compactness factor for superpixel generation, it should be set as 30 for noisy environment, 10 for noise-free environment. 
% G_low and G_high should be set as 0.1 and 0.8, respectively.
