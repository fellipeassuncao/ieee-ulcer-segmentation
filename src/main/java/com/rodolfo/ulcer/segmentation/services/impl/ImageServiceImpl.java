...
public class ImageServiceImpl implements ImageService {
	...
	public void save(Image image) {
		...
		if(image.getGrabCutFinalUlcerSegmentation() != null) {

			IMAGE_REPOSITORY.save(image.getGrabCutFinalUlcerSegmentation(), image.getDirectory().getGrabCutSegmentationPath());
		}

		if(image.getGrabCutFinalBinarySegmentation() != null) {

			IMAGE_REPOSITORY.save(image.getGrabCutFinalBinarySegmentation(), image.getDirectory().getGrabCutSegmentationBinaryPath());
		}

		if(image.getMlCLassifiedImage() != null) {

			IMAGE_REPOSITORY.save(image.getMlCLassifiedImage(), image.getDirectory().getSvmClassificationPath());
		}
