...
public class SceneController implements Initializable {
    ...
    @FXML
    private RadioButton methodDISF;

    @FXML
    private RadioButton methodERS;

    @FXML
    private RadioButton methodTURBOPIXEL;

    @FXML
    private RadioButton methodSH;

    @FXML
    private RadioButton methodSNIC;
    ...
    @FXML
    private TextField lambdaPrime;

    @FXML
    private TextField sigma;

    @FXML
    private TextField conn8;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try(InputStream input = SceneController.class.getClassLoader().getResourceAsStream(this.PROPERTIES)) {
            ...
            this.configuration.setSkeletonWithBranchsName(properties.getProperty("image.skeleton.with.branchs"));
            this.configuration.setSkeletonWithoutBranchsName(properties.getProperty("image.skeleton.without.branchs"));
            ...
            this.configuration.setDatasourceDISFName(properties.getProperty("ml.file.datasource.disf.name"));
            this.configuration.setDatasourceERSName(properties.getProperty("ml.file.datasource.ers.name"));
            this.configuration.setDatasourceSNICName(properties.getProperty("ml.file.datasource.snic.name"));
            ...
            this.configuration.setMinMaxDISFName(properties.getProperty("ml.file.min.max.disf.name"));
            this.configuration.setMinMaxERSName(properties.getProperty("ml.file.min.max.ers.name"));
            this.configuration.setMinMaxSNICName(properties.getProperty("ml.file.min.max.snic.name"));
            ...
            this.configuration.setMlModelDISFName(properties.getProperty("ml.file.disf.model"));
            this.configuration.setMlModelERSName(properties.getProperty("ml.file.ers.model"));
            this.configuration.setMlModelSNICName(properties.getProperty("ml.file.snic.model"));
    ...
    private void setWorkerProperties(WorkerMonitor wMonitor) {
        ...
        this.methodDISF.disableProperty().bind(wMonitor.getIdle().not());
        this.methodERS.disableProperty().bind(wMonitor.getIdle().not());
        this.methodTURBOPIXEL.disableProperty().bind(wMonitor.getIdle().not());
        this.methodSH.disableProperty().bind(wMonitor.getIdle().not());
        this.methodSNIC.disableProperty().bind(wMonitor.getIdle().not());
    ...
    private void reset() {
        ...
        this.methodDISF.disableProperty().unbind();
        this.methodERS.disableProperty().unbind();
        this.methodTURBOPIXEL.disableProperty().unbind();
        this.methodSH.disableProperty().unbind();
        this.methodSNIC.disableProperty().unbind();
    ...
    private MethodEnum getSelectedMethod() {
        ...
        return 
            ...
            this.methodLSC.isSelected()  ? MethodEnum.LSC    :
            this.methodSLIC.isSelected()  ? MethodEnum.SLIC  :
            this.methodDISF.isSelected()  ? MethodEnum.DISF  :
            this.methodERS.isSelected()  ? MethodEnum.ERS    :
            this.methodTURBOPIXEL.isSelected()  ? MethodEnum.TURBOPIXEL  :
            this.methodSH.isSelected()  ? MethodEnum.SH  :
            MethodEnum.SNIC;
    ...
    private List<String> validateParameters() {
        ...
        if(!StringUtils.isNotBlank(this.seeds.getText()) || !NumberUtils.isCreatable(this.seeds.getText())) {

            errors.add("Necessário informar a quantidade de sementes. Têm que obdecer o formato numérico");
        }

        if(!StringUtils.isNotBlank(this.lambdaPrime.getText()) || !NumberUtils.isCreatable(this.lambdaPrime.getText())) {

            errors.add("Necessário informar o lambdaprime. Têm que obdecer o formato numérico");
        }

        if(!StringUtils.isNotBlank(this.sigma.getText()) || !NumberUtils.isCreatable(this.sigma.getText())) {

            errors.add("Necessário informar o sigma. Têm que obdecer o formato numérico");
        }
        if(!StringUtils.isNotBlank(this.conn8.getText()) || !NumberUtils.isCreatable(this.conn8.getText())) {

            errors.add("Necessário informar o conn8. Têm que obdecer o formato numérico");
        }
