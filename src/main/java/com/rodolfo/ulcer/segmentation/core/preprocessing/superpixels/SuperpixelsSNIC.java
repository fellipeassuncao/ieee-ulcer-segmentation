...
@Slf4j
public class SuperpixelsSNIC extends Superpixels {
    // Criar objeto da classe Superpixel
    public SuperpixelsSNIC(Image image, Integer imageEdge, Integer iterations, Integer amount, Integer seeds) {
    ...
    public void createSuperpixels() {
        ...
        log.info("Segmentando a imagem em superpixel com o método SNIC");
        ...
        try {
            proc = Runtime.getRuntime().exec(
                new String[]{
                    "C:/repositories/snic-teste/snic.exe",
       ...
       */
       // Atribuir as imagens geradas pelo SNIC
