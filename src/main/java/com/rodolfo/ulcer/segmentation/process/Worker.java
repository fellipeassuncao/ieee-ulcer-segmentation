...
import com.rodolfo.ulcer.segmentation.core.preprocessing.superpixels.SuperpixelsDISF;
import com.rodolfo.ulcer.segmentation.core.preprocessing.superpixels.SuperpixelsERS;
import com.rodolfo.ulcer.segmentation.core.preprocessing.superpixels.SuperpixelsSNIC;
...
public class Worker extends Task<Void> {
    ...
    private void segmentation() throws Exception {
        ...
        // Long superpixelsTime = System.currentTimeMillis();
        ...
        grabcut.createGrabCutFinalBinarySegmentation();
        ...
        if(this.image.getDirectory().hasLabeledImagePath()) {
            ...
            grabImageStatistic = new ImageStatistic.Builder(
                ...
                superpixels.getSuperpixelsAmount(), 
                execGrabTime
            ).overlappingImage(grabcut.getGrabCutFinalBinarySegmentation(), this.image.getLabeledFilledContourImage())
            .hasLabeledImage()
            .sensitivity()
            .specificity()
            .precision()
        ...
        this.image.setGrabCutFinalUlcerSegmentation(grabcut.getGrabCutFinalUlcerSegmentation());
        this.image.setGrabCutFinalBinarySegmentation(grabcut.getGrabCutFinalBinarySegmentation());
        ...
        FILE_SERVICE.saveImageStatistics(
            ...
            svmImageStatistic.getImage().getDirectory().getStatisticsVisualizationPath()
        );
        updateProgress(maxProcess, maxProcess);
    ...
    private Superpixels createSuperpixelsMethod() {
        ...
        switch (this.methodEnum) {
            ...
            case DISF:
                ...
                superpixels = new SuperpixelsDISF(
                    this.image, 
                    this.conf.getImageEdgePixelDistance(), 
                    this.conf.getIterations(),
                    this.conf.getAmount(), 
            ...
            case ERS:
                ...
                superpixels = new SuperpixelsERS(
                    this.image, 
                    this.conf.getImageEdgePixelDistance(), 
                    this.conf.getIterations(),
                    this.conf.getAmount(), 
            ...
            superpixels = new SuperpixelsSNIC(
                this.image, 
                this.conf.getImageEdgePixelDistance(), 
                this.conf.getIterations(),
                this.conf.getAmount(), 
